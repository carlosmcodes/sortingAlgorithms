...
public interface Sorter {
	 ...
	 * 
	 * @param firstIndex Index of the first element to be sorted.
	 * 
	 * @param numberToSort The number of elements in the section to be sorted.
	 */
	 ...
	 * 
	 * @param data The list of elements to merge
	 * 
	 * @param firstIndex Index of the first element of the left segment.
	 * 
	 * @param leftSegmentSize The number of elements in the left segment.
	 * 
	 * @param rightSegmentSize The number of elements in the right segment.
	 */
	 ...
	 * 
	 * @param data The list to heapify.
	 */
